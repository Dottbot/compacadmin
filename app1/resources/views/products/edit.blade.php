        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input id="status" type="text" class="form-control" name="status" value="" autofocus>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input id="sellingprice" type="text" class="form-control" name="sellingprice" value="" autofocus>
