                ...
                <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
                   <div class="container-fluid navbar-inner">
                      ...
                      <div class="sidebar-toggle" data-toggle="sidebar" data-active="true">
                         <i class="icon d-flex">
                            <svg class="icon-20" width="50" viewBox="0 0 24 24">
                      ...
                      <div class="d-flex align-items-center justify-content-between product-offcanvas">
                         <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Update information</small>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        <div>
                                            <h1>Hello,<b> </b></h1>
                                            <h2>Please update product info</h2>
               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">Display User Info</h4>

                     </div>
                  </div>
                  <div class="formupdation">
                  ...
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        ...
                        <div class="infogather">
                            <div class="form1">
    <form id="validation" method="POST" action="{{ route('products.store') }}">
        @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="sku" class="form-label"><b>{{ __('SKU') }}</b></label>
                            

                            <input id="sku" type="text" class="form-control" name="sku" value="" required autocomplete="sku">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="quantity" class="form-label"><b>{{ __('QUANTITY') }}</b></label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="price" class="form-label"><b>{{ __('PRICE') }}</b></label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="sellingprice" class="form-label"><b>{{ __('SELLING PRICE') }}</b></label>
                            

                            <input id="sellingprice" type="text" class="form-control" onfocusout="compare1();" name="sellingprice">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="status" class="form-label"><b>{{ __('STATUS') }}</b></label>
                            

                            <input id="status" type="text" class="form-control" name="status" value="" >
                ...
                <div class="d-flex justify-content-center">
                    <input type="hidden" id="btn111" value="">
                    
                    <button type="submit" id="addproductbtn" onclick="dis();" class="btn btn-primary">
                        {{ __('ADD PRODUCT') }}
                    </button>
...
<!-- Live Customizer end -->
    ...
    var b = document.getElementById('sellingprice').value;
    

    
    if(a >= b && b!=0){
        var error=document.getElementById('error');
        error.textContent = "price<sellingprice"
            error.style.color = "red"
            var btni = document.getElementById('btn111');
            btn111.setAttribute('value', error); 
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    if(a >= b && b!=0){
        ...
        function dis(){
            ...
            confirm("do you want to submit product details?");
