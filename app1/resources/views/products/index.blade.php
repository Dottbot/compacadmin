         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  ...
                  <h4 class="card-title" style="padding-left: 450px"><b>Product List</b></h4>
               </div>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="flex align-items-center list-user-action">
                                 <a class="btn btn-sm btn-icon btn-success rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Add" href="product">
                                 ...
                                 <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="{{ route('products.edit', $product) }}">
                                    <span class="btn-inner">
                                 ...
                                 <a type="submit" class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Delete" href="/products/product/{{$product->id}}" onclick="return confirm('Are you sure you want to delete this product?');">
                                    <span class="btn-inner">
