               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">Delete User Information</h4>
                     </div>
                  </div>
                        
                        <div class="infogather">
                            <div class="form1">
                                <form action="{{ route('deleteu',) }}" method="post">
                                      ...
                                      <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$username}}" autocomplete="name" autofocus>
                               ...
                               @enderror
                                         ...
                                         <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="phonenum" class="form-label"><b>{{ __('Phone no') }}</b></label>
                                                
            
                                                <input id="phonenum" type="text" class="form-control" name="phonenum" value="{{$phonenumber}}" autofocus>
                                         ...
                                         <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$emailid}}" autocomplete="email">
